...
public final class QueryException extends AbstractException {
     ...
     */
    public QueryException(long errorCode, String messageKey, Object... collections) {
     ...
     *                    <span class="zh-CN">用于资源信息格式化的参数</span>
     */
    public QueryException(long errorCode, String messageKey, Throwable cause, Object... collections) {
