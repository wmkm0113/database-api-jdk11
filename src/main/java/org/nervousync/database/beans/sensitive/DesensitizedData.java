...
public final class DesensitizedData {
    ...
    /**
     * <h3 class="en-US">Private constructor for desensitized data definition</h3>
     * <h3 class="zh-CN">脱敏数据定义的私有构造方法</h3>
     *
    ...
    /**
     * <h3 class="en-US">Static methods are used to generate desensitized data definition instance objects</h3>
     * <h3 class="zh-CN">静态方法用于生成脱敏数据定义实例对象</h3>
     *
